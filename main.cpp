...
int main(int argc, char *argv[])
{
    ...
    //     igl::writeOBJ(datafile+"simplejoint-modes-skinned-clustered"+to_string(run)+".obj",newV, F);
    //     igl::writeDMAT(datafile+"simplejoint-modes-skinned-clustered_V"+to_string(run)+".dmat",newV);
